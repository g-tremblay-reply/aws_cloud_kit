...
void ether_eint_isr(void);
        ...
        #define VECTOR_NUMBER_SCI5_RXI ((IRQn_Type) 2) /* SCI5 RXI (Received data full) */
        #define SCI5_RXI_IRQn          ((IRQn_Type) 2) /* SCI5 RXI (Received data full) */
        #define VECTOR_NUMBER_SCI5_TXI ((IRQn_Type) 3) /* SCI5 TXI (Transmit data empty) */
        #define SCI5_TXI_IRQn          ((IRQn_Type) 3) /* SCI5 TXI (Transmit data empty) */
        #define VECTOR_NUMBER_SCI5_TEI ((IRQn_Type) 4) /* SCI5 TEI (Transmit end) */
        #define SCI5_TEI_IRQn          ((IRQn_Type) 4) /* SCI5 TEI (Transmit end) */
        #define VECTOR_NUMBER_SCI5_ERI ((IRQn_Type) 5) /* SCI5 ERI (Receive error) */
        #define SCI5_ERI_IRQn          ((IRQn_Type) 5) /* SCI5 ERI (Receive error) */
        #define VECTOR_NUMBER_FCU_FRDYI ((IRQn_Type) 6) /* FCU FRDYI (Flash ready interrupt) */
        #define FCU_FRDYI_IRQn          ((IRQn_Type) 6) /* FCU FRDYI (Flash ready interrupt) */
        #define VECTOR_NUMBER_FCU_FIFERR ((IRQn_Type) 7) /* FCU FIFERR (Flash access error interrupt) */
        #define FCU_FIFERR_IRQn          ((IRQn_Type) 7) /* FCU FIFERR (Flash access error interrupt) */
        ...
        #define VECTOR_NUMBER_ICU_IRQ15 ((IRQn_Type) 12) /* ICU IRQ15 (External pin interrupt 15) */
        #define ICU_IRQ15_IRQn          ((IRQn_Type) 12) /* ICU IRQ15 (External pin interrupt 15) */
        ...
        #define VECTOR_NUMBER_ICU_IRQ14 ((IRQn_Type) 14) /* ICU IRQ14 (External pin interrupt 14) */
        #define ICU_IRQ14_IRQn          ((IRQn_Type) 14) /* ICU IRQ14 (External pin interrupt 14) */
